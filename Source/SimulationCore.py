...
class Simulation:
    ...
    def update(dT):
        ...
        ProspectivePosition = self.robot.pos + speed*self.robot.maxSpeed*dT*self.SimSpeed
        self.IsColliding=Collision(ProspectivePosition, self.robot.diameter/2, self.FloorPlan)
