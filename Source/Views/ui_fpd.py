...
class Ui_FPDWindow(object):
    def setupUi(self, FPDWindow):
        ...
        self.roomXLabel = QtWidgets.QLabel(self.MenuVLayout)
        self.roomXLabel.setObjectName("roomXLabel")
        self.XLayout.addWidget(self.roomXLabel)
        spacerItem1 = QtWidgets.QSpacerItem(
            40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum
        )
        self.XLayout.addItem(spacerItem1)
        self.roomXBox = QtWidgets.QSpinBox(self.MenuVLayout)
        sizePolicy = QtWidgets.QSizePolicy(
            QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed
        )
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.roomXBox.sizePolicy().hasHeightForWidth())
        self.roomXBox.setSizePolicy(sizePolicy)
        self.roomXBox.setMinimumSize(QtCore.QSize(105, 25))
        ...
        self.XLayout.addWidget(self.roomXBox)
        self.ItemDimVLayout.addLayout(self.XLayout)
        self.YLayout = QtWidgets.QHBoxLayout()
        self.YLayout.setObjectName("YLayout")
        self.roomYLabel = QtWidgets.QLabel(self.MenuVLayout)
        self.roomYLabel.setObjectName("roomYLabel")
        self.YLayout.addWidget(self.roomYLabel)
        spacerItem2 = QtWidgets.QSpacerItem(
            40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum
        )
        self.YLayout.addItem(spacerItem2)
        self.roomYBox = QtWidgets.QSpinBox(self.MenuVLayout)
        sizePolicy = QtWidgets.QSizePolicy(
            QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed
        )
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.roomYBox.sizePolicy().hasHeightForWidth())
        self.roomYBox.setSizePolicy(sizePolicy)
        self.roomYBox.setMinimumSize(QtCore.QSize(105, 25))
        ...
        self.YLayout.addWidget(self.roomYBox)
        self.ItemDimVLayout.addLayout(self.YLayout)
        ...
        self.WidthLayout.addItem(spacerItem3)
        ...
        self.HeightLayout.addItem(spacerItem4)
        ...
        self.SimButtonLayout.addItem(spacerItem6)
        ...
        self.SimButtonLayout.addItem(spacerItem7)
        ...
        self.FPDTitleHLayout.addItem(spacerItem8)
        ...
        self.FPDTitleHLayout.addItem(spacerItem9)
        ...
        # self.FPDGraphicsView.setSizePolicy(QSizePolicy.Fixed, QSizePolicy.Fixed)
    ...
    def retranslateUi(self, FPDWindow):
        ...
        self.addFurnitureButton.setText(_translate("FPDWindow", "Add furniture"))
        ...
        self.roomXLabel.setText(_translate("FPDWindow", "Item X"))
        self.roomYLabel.setText(_translate("FPDWindow", "Item Y"))
